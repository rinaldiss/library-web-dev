        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="text-center">
                    <div class="h1 text-primary mb-5">Pencarian Buku Induk</div>
                </div>
                <div class="row">
                    <div class="col-xl-4 col-md-6 mb-4">
                        <a href="{{ route('search.regulation') }}" class="text-decoration-none">
                    ...
                    <div class="col-xl-4 col-md-6 mb-4">
                        <a href="{{ route('search.magazine') }}" class="text-decoration-none">
                            <div class="featured-block">
                                <div class="card shadow bg-primary h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-xl-4 col-md-6 mb-4">
                        <a href="{{ route('search.book') }}" class="text-decoration-none">
                            <div class="featured-block">
                                <div class="card shadow bg-primary h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
